...
/***/ function(module, exports, __webpack_require__) {
	...
	var caseEvents = __webpack_require__(31);
	var projectEvents = __webpack_require__(7);
	$(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var auth_api = __webpack_require__(4);
	var auth_ui = __webpack_require__(6);
	var getFormFields = __webpack_require__(30);

	var onSignUp = function onSignUp(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  auth_api.signUp(data).then(auth_ui.success).fail(auth_ui.error);
	};

	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  auth_api.signIn(data).then(auth_ui.signInSuccess).fail(auth_ui.failure);
	};

	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  auth_api.signOut().then(auth_ui.signOutSuccess).fail(auth_ui.failure);
	};

	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  auth_api.changePassword(data).then(auth_ui.changePasswordSuccess).fail(auth_ui.failure);
	};
...
/***/ function(module, exports) {
	...
	// let host = 'http://localhost:4741/';
	var host = 'https://glacial-taiga-90210.herokuapp.com';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(5);
	var projects_events = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var projects_api = __webpack_require__(8);
	var projects_ui = __webpack_require__(9);
	var getFormFields = __webpack_require__(30);
	...
	var onCreateProject = function onCreateProject(event) {
	  event.preventDefault();
	  var project = getFormFields(event.target);
	  projects_api.createProject(project).then(function (data) {
	...
	var onListProjects = function onListProjects() {
	  projects_api.listProjects().then(projects_ui.listProjectsSuccess).fail(console.log('list projects fail'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(5);
	var listProjectsTemplates = __webpack_require__(10);

	var listProjectsSuccess = function listProjectsSuccess(data) {
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  listProjectsSuccess: listProjectsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var case_api = __webpack_require__(32);
	var case_ui = __webpack_require__(33);
	var getFormFields = __webpack_require__(30);
	...
	var onGetCase = function onGetCase(event) {
	  event.preventDefault();
	  // randomCase();
	  case_api.getCase().then(case_ui.createCaseSuccess).fail(case_ui.fail);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createCaseSuccess = function createCaseSuccess(data) {
	  var cas = data[0];
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  createCaseSuccess: createCaseSuccess
